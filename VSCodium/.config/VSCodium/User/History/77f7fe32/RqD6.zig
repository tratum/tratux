...
fn whileLoops() void {
    ...
    while (true) {
        dex+=1;
        if (dex>10) break;  // if this line gets commented then the while loop will go on forever until it exhausts the 8 bits that it's been assigned meaning it will go on until 255 and then
        print("the index is {} \n", .{dex});
    } 
