...
sudo dnf copr enable lukenukem/asus-linux solopasha/hyprland wojnilowicz/ungoogled-chromium varlad/eww -y

## Installing Packages
sudo dnf install zsh git fastfetch flatpak htop btop nvtop alacritty waybar rofi-wayland hyprlock hypridle wofi pamixer blueman grim slurp wl-clipboard jq dunst viewnior libnotify sddm qt6-qtsvg qt6-qtvirtualkeyboard qt6-qtmultimedia ungoogled-chromium -y
