...
update_gtk_theming() {
  case "$1" in
    d)
      ...
      sed -i "8 c gsettings set org.gnome.desktop.interface icon-theme 'Win10Sur-dark'" "$SWAY_CONFIG"
      sed -i "9 c gsettings set org.gnome.desktop.interface color-scheme 'prefer-dark'" "$SWAY_CONFIG"
