...
fn convertingSimilarTypes() void {
    ...
    const num1:u32 = 1000000;
    const num2:u16 = @truncate(num1);

    print("Num1: {}\n", .{num1});
    print("Num2: {}\n", .{num2});

    // WHat happened was that we removed the extra bits from num1 which is 32 bits to fit into num2 which is 16 bits and stored the maximum value that can be stored in
