...
fn convertingSimilarTypes() void {
    ...
    const num1:i32 = 100000000;
    const num2:i16 = @truncate(num1);

    print("Num1: {}", .{num1});
    print("Num2: {}", .{num2});

    // WHat happened was that we removed the extra bits from the num1 to fit it into num2 which is of 16 bits

    print("Binary Representation: {b}", .{num1});
    print("Binary Representation: {b}", .{num2});
